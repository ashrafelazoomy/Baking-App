...
import com.example.adam.baking_app.GlobalApplication;
import com.example.adam.baking_app.Pref;
import com.example.adam.baking_app.R;
import com.example.adam.baking_app.adapters.RecipesAdapter;
import com.example.adam.baking_app.api.RecipesApiCallback;
import com.example.adam.baking_app.api.RecipesApiManager;
import com.example.adam.baking_app.models.Recipe;
import com.example.adam.baking_app.utils.Misc;
import com.example.adam.baking_app.widgets.AppWidgetService;
            ...
            RecipesApiManager.getInstance().getRecipes(new RecipesApiCallback<List<Recipe>>() {
                ...
                public void onResponse(final List<Recipe> result) {
                    if (result != null) {
                        ...
                        if (Pref.loadRecipe(getActivity().getApplicationContext()) == null) {
