...
import com.example.adam.baking_app.ui.RecipeInfoActivity;
import com.example.adam.baking_app.ui.RecipeStepDetailActivity;
...
public class BakingRecipesTests extends BaseTest {
    ...
    public void checkAddWidgetButtonFunctionality() {
        ...
        globalApplication.getSharedPreferences(Pref.PREFS_NAME, Context.MODE_PRIVATE).edit()
                .clear()
                .commit();
        ...
        Recipe recipe = Pref.loadRecipe(globalApplication);
